...
- [**More Info On Execution Of The Console**](#more-info-on-execution-of-the-console)
- [**Background Contexts**](#background-contexts)
   - [**What’s a command interpreter?**](#what’s-a-command-interpreter?)
- [Tasks 0 README, AUTHORS](#tasks-0-readme,-authors)
- [Task 1 Be pycodestyle compliant!](#task-1-be-pycodestyle-compliant!)
- [Task 2 Unittests](#task-2-unittests)
...
## [More Info On Execution Of The Console] <a name="more-info-on-execution-of-the-console"></a>
...
![image](https://github.com/Abel-alx-github/AirBnB_clone/assets/138770113/9cadeffe-6621-4b63-8bc2-3e3ab32661f3)


       
## Background Contexts <a name="background-contexts"></a>
...
### [Tasks 0 README, AUTHORS] <a name="tasks-0-readme,-authors"></a>
...
### [Task 1 Be pycodestyle compliant!] <a name="task-1-be-pycodestyle-compliant!"></a>

> Write beautiful code that passes the pycodestyle checks.


### [Task 2 Unittests] <a name="task-2-unittests"></a>
...
### [Task 3 BaseModel] <a name="task-3-baseModel"></a>
...
### [Task 4 Create BaseModel from dictionary] <a name="task-4-create-baseModel-from-dictionary"></a>
...
**you can test using this test file**
~~~
...
### [Task 5 Store first object] <a name="task-5-store-first-object"></a>
